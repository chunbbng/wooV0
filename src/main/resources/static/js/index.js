...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 초기값 0분으로 설정
    document.getElementById('timeValue').textContent = '0분';
    ...
    secondSlider.noUiSlider.on('update', function (values, handle) {
        ...
        document.getElementById('timeValue').textContent = combinedValue + '분';
        document.getElementById('secondEstimatedTime').value = values[handle].replace('분', '');
    });
    ...
    expandButton.addEventListener('click', function () {
        if (secondSliderContainer.style.display === 'none' || secondSliderContainer.style.display === '') {
            ...
            expandButton.classList.add('up');
        } else {
            secondSliderContainer.style.display = 'none';
            expandButton.classList.remove('up');
            document.getElementById('timeValue').textContent = predictSlider.noUiSlider.get();
        }
    });
});
